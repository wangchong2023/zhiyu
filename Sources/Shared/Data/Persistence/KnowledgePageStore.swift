...
//
// 作者: Wang Chong
// 功能说明: 本文件实现了知识管理系统的核心持久化引擎（KnowledgePageStore），封装了基于 GRDB 的高性能数据库访问逻辑。
// 该组件不仅作为 知识库 页面数据的 CRUD 中心，还承载了系统的高级知识检索与关联能力，核心功能点如下：
...
//   - 2026-05-07: 系统性重构，从 WikiPageStore 重命名为 KnowledgePageStore，术语统一为“知识库/页面存储”
// 日期: 2026-05-07
