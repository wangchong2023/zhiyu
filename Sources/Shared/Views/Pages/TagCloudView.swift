...
struct TagCloudViewContent: View {
    ...
    private var mainContent: some View {
        VStack(spacing: 0) {
            ...
            .padding(.vertical, AppUI.Layout.headerVerticalPadding)
    ...
    private var emptyTagsView: some View {
        VStack(spacing: AppUI.medium) {
            Image(systemName: "tag")
                .font(.system(size: AppUI.iconHuge))
                .foregroundStyle(.appSecondary)
    ...
    private var tagScrollView: some View {
        ScrollView {
            FlowLayout(spacing: AppUI.Grid.flowSpacing) {
                ...
                if isEditMode {
                    ZStack {
                        Circle()
                            ...
                            .frame(width: AppUI.headlineFontSize, height: AppUI.headlineFontSize)
                        
                        if isSelected {
                            Image(systemName: "checkmark")
                                .font(.system(size: AppUI.microFontSize, weight: .black))
                                .foregroundStyle(.white)
                        } else {
                            Circle()
                    ...
                    .offset(x: AppUI.small, y: -AppUI.small)
                }
            }
        }
        .buttonStyle(.plain)
