...
//
// 作者: Wang Chong
// 功能说明: [L2] 业务功能层：Apple Vision Pro 空间计算视图，提供沉浸式知识可视化体验。
// 版本: 1.0
// 修改记录:
//   - 创建: 2026-05-02
// 日期: 2026-05-04
...
struct VisionProSpatialView: View {
    ...
    private func createPageEntity(page: KnowledgePage, position: SIMD3<Float>) -> ModelEntity {
        ...
        let color = UIColor(Color.fromModelColorName(page.pageType.colorName))
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: DesignSystem.cardRadius)
                ...
                .shadow(color: Color.fromModelColorName(page.pageType.colorName).opacity(0.3), radius: 4)
        )
        .overlay(
            RoundedRectangle(cornerRadius: DesignSystem.cardRadius)
                .strokeBorder(Color.fromModelColorName(page.pageType.colorName).opacity(0.4), lineWidth: 1)
        )
    }
}
