...
extension L10n {
    public struct Auth {
        ...
        public static var phonePlaceholder: String { Localized.tr("auth.phone.placeholder", table: "Auth") }
        public static var setPasswordPlaceholder: String { Localized.tr("auth.setPassword.placeholder", table: "Auth") }
