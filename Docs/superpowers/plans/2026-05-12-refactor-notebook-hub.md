...
- [x] **Step 3: Fix imports and compile**
...
- [x] **Step 2: Fix imports and compile**
- [x] **Step 3: Commit**
...
- [x] **Step 1: Update Root Logic**
Change `body` to check `AuthSession.isLoggedIn`.
- [x] **Step 2: Add Hub/Notebook Transition**
...
- [x] **Step 1: Add 'healthCheck' to ToolItem**
```swift
...
```
- [x] **Step 2: Fix iPad Performance Sheet**
Add `.sheet(isPresented: $store.showPerfDashboard)` to `adaptiveSplitView`.
- [x] **Step 3: Final Compile and Test**
