...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KM",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC2KM20CollaborationService")
...
SWIFT_CLASS("_TtC2KM21AppWindowSceneDelegate") SWIFT_AVAILABILITY(maccatalyst,introduced=16.0) SWIFT_AVAILABILITY(ios,introduced=16.0)
...
@class NSData;
@class MCSession;
SWIFT_CLASS("_TtC2KM24MCAdvertiserDelegateImpl")
...
@class NSString;
SWIFT_CLASS("_TtC2KM21MCBrowserDelegateImpl")
...
SWIFT_CLASS("_TtC2KM21MCSessionDelegateImpl")
...
@class UITextView;
SWIFT_CLASS("_TtC2KM27MarkdownTextViewCoordinator")
...
SWIFT_CLASS("_TtC2KM13PencilManager")
...
@interface PencilManager (SWIFT_EXTENSION(KM)) <UIPencilInteractionDelegate>
- (void)pencilInteractionDidTap:(UIPencilInteraction * _Nonnull)interaction;
@end

@class WCSession;
/// 跨端通信服务 (Shared across iOS & watchOS)
SWIFT_CLASS("_TtC2KM24WatchConnectivityService")
