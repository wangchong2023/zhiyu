...
#ifndef KMMAC_SWIFT_H
#define KMMAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KMMac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5KMMac20CollaborationService")
@interface CollaborationService : NSObject
...
SWIFT_CLASS("_TtC5KMMac21AppWindowSceneDelegate") SWIFT_AVAILABILITY(maccatalyst,introduced=16.0) SWIFT_AVAILABILITY(ios,introduced=16.0)
@interface AppWindowSceneDelegate : NSObject <UIWindowSceneDelegate>
...
@class NSData;
@class MCSession;
SWIFT_CLASS("_TtC5KMMac24MCAdvertiserDelegateImpl")
@interface MCAdvertiserDelegateImpl : NSObject <MCNearbyServiceAdvertiserDelegate>
...
@class NSString;
SWIFT_CLASS("_TtC5KMMac21MCBrowserDelegateImpl")
@interface MCBrowserDelegateImpl : NSObject <MCNearbyServiceBrowserDelegate>
...
SWIFT_CLASS("_TtC5KMMac21MCSessionDelegateImpl")
@interface MCSessionDelegateImpl : NSObject <MCSessionDelegate>
- (void)session:(MCSession * _Nonnull)session peer:(MCPeerID * _Nonnull)peerID didChangeState:(MCSessionState)newState;
...
@class UITextView;
SWIFT_CLASS("_TtC5KMMac27MarkdownTextViewCoordinator")
@interface MarkdownTextViewCoordinator : NSObject <UITextViewDelegate>
...
SWIFT_CLASS("_TtC5KMMac13PencilManager")
@interface PencilManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class UIPencilInteraction;
@interface PencilManager (SWIFT_EXTENSION(KMMac)) <UIPencilInteractionDelegate>
- (void)pencilInteractionDidTap:(UIPencilInteraction * _Nonnull)interaction;
@end

@class WCSession;
/// 跨端通信服务 (Shared across iOS & watchOS)
SWIFT_CLASS("_TtC5KMMac24WatchConnectivityService")
